...
output_profile_name = os.path.join(output_profile_folder, 'GNSS_Demo_5_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'GNSS_Demo_5_Errors.csv')
