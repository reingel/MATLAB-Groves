...
#
# Created 12/4/12 by Paul Groves, converted to Python 6/6/2025
...
output_profile_name = os.path.join(output_profile_folder, 'GNSS_Demo_3_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'GNSS_Demo_3_Errors.csv')
