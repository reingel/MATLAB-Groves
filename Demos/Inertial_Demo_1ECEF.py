...
from Inertial_navigation_ECEF import Inertial_navigation_ECEF
...
output_profile_name = os.path.join(output_profile_folder, 'Inertial_Demo_1ECEF_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'Inertial_Demo_1ECEF_Errors.csv')
...
out_profile, out_errors = Inertial_navigation_ECEF(in_profile, no_epochs, initialization_errors, IMU_errors)
