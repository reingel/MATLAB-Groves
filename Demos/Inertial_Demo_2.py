...
output_profile_name = os.path.join(output_profile_folder, 'Inertial_Demo_2_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'Inertial_Demo_2_Errors.csv')
