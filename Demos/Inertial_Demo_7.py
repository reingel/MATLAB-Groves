...
output_profile_name = os.path.join(output_profile_folder, 'Inertial_Demo_7_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'Inertial_Demo_7_Errors.csv')
