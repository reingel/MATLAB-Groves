...
output_profile_name = os.path.join(output_profile_folder, 'INS_GNSS_Demo_4_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'INS_GNSS_Demo_4_Errors.csv')
