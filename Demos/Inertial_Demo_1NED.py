...
output_profile_name = os.path.join(output_profile_folder, 'Inertial_Demo_1NED_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'Inertial_Demo_1NED_Errors.csv')
