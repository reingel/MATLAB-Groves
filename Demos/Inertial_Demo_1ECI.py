...
from Inertial_navigation_ECI import Inertial_navigation_ECI
...
output_profile_name = os.path.join(output_profile_folder, 'Inertial_Demo_1ECI_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'Inertial_Demo_1ECI_Errors.csv')
...
# ECI Inertial navigation simulation
out_profile, out_errors = Inertial_navigation_ECI(in_profile, no_epochs, initialization_errors, IMU_errors)
