...
#
# Created 27/5/12 by Paul Groves, converted to Python 6/7/2025
...
input_profile_name = os.path.join(input_profile_folder, 'Profile_4.csv')
# Output motion profile and error filenames
output_profile_name = os.path.join(output_profile_folder, 'GNSS_Demo_6_Profile.csv')
output_errors_name = os.path.join(output_profile_folder, 'GNSS_Demo_6_Errors.csv')
