"""
Adjust_profile_position.py - Adjusts the position in a motion profile file to
...
from Update_curvilinear_position import update_curvilinear_position


def adjust_profile_position(in_filename: str, out_filename: str) -> None:
    """
    Adjusts the position in a motion profile file to make it consistent with the velocity.
    ...
    for epoch in range(1, no_epochs):
        ...
        # Update position
        L_b, lambda_b, h_b = update_curvilinear_position(
            tor_i, old_L_b, old_lambda_b, old_h_b, old_v_eb_n, v_eb_n
        )
...
if __name__ == "__main__":
    ...
    adjust_profile_position(input_file, output_file)