...
from LC_KF_Epoch import LC_KF_Epoch
    ...
    for epoch in range(1, no_epochs):
        ...
        if (time - time_last_GNSS) >= GNSS_config['epoch_interval']:
            ...
            est_C_b_e, est_v_eb_e, est_r_eb_e, est_IMU_bias, P_matrix = LC_KF_Epoch(
                GNSS_r_eb_e, GNSS_v_eb_e, tor_s, est_C_b_e, est_v_eb_e, est_r_eb_e,
                est_IMU_bias, P_matrix, meas_f_ib_b, est_L_b, LC_KF_config
            )
